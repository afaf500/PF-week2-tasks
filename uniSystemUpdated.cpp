...
main()
{
    ...
    string pref1Array[totalStudent] = {"CE", "EE", "CS", "EE", "CS", "CE","EE"};
    string pref2Array[totalStudent] = {"CS", "CE", "EE", "CE", "EE", "CS","CE"};
    string pref3Array[totalStudent] = {"EE", "CS", "CE", "CS", "CE", "EE","CS"};
